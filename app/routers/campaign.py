...
@router.get("/{id}/campaign-tasks", response_model=list[CampaignTaskResponse], summary="Lấy danh sách nhiệm vụ theo id chiến dịch", status_code=status.HTTP_200_OK)
