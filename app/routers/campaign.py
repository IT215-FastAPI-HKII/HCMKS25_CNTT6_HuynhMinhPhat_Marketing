...
@router.post("", response_model=CampaignResponse, summary="Tạo chiến dịch", status_code=status.HTTP_201_CREATED)
...
@router.get("", response_model=list[CampaignResponse], summary="Lấy danh sách chiến dịch", status_code=status.HTTP_200_OK)
...
@router.get("/{id}", response_model=CampaignResponse, summary="Lấy chiến dịch theo id", status_code=status.HTTP_200_OK)
...
@router.put("/{id}", response_model=CampaignResponse, summary="Cập nhật toàn bộ thông tin chiến dịch", status_code=status.HTTP_200_OK)
...
@router.patch("/{id}", response_model=CampaignResponse, summary="Cập nhật chiến dịch", status_code=status.HTTP_200_OK)
...
@router.delete("/{id}", summary="Xóa chiến dịch", status_code=status.HTTP_200_OK)
...
@router.post("/{id}/members", response_model=UserResponse, summary="Thêm thành viên vào chiến dịch", status_code=status.HTTP_201_CREATED)
...
@router.delete("/{id}/members/{user_id}", summary="Xóa thành viên khỏi chiến dịch", status_code=status.HTTP_200_OK)
...
@router.get("/{id}/members", response_model=list[CampaignMemberResponse], summary="Danh sách thành viên theo id chiến dịch", status_code=status.HTTP_200_OK)
...
@router.post("/{id}/campaign-tasks", response_model=CampaignTaskResponse, summary="Tạo nhiệm vụ trong chiến dịch", status_code=status.HTTP_201_CREATED)
...
@router.get("/campaigns/{id}/campaign-tasks", response_model=list[CampaignTaskResponse], summary="Lấy danh sách nhiệm vụ theo id chiến dịch", status_code=status.HTTP_200_OK)
